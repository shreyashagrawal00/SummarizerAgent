      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="space-y-8">
          <div className="text-center space-y-3">
            <h1 className="font-display text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white transition-colors">PDF Summarizer</h1>
            <p className="text-slate-600 dark:text-slate-400 text-base sm:text-lg transition-colors">Upload any PDF document and let our AI distill it into a concise summary.</p>
          </div>
              ...
              <div className="border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-xl p-6 sm:p-12 text-center hover:border-primary dark:hover:border-primary transition-colors cursor-pointer group relative">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-sm transition-colors">PDF files up to 10MB</p>
                  </div>
                </div>
              </div>
          ...
          {summary && (
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500 transition-colors">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-100 dark:border-slate-800 p-6 sm:p-8 pb-4 sm:pb-4 gap-4 bg-slate-50/50 dark:bg-slate-800/50 transition-colors">
                <div className="flex items-center gap-3">
                  <span className="material-symbols-outlined text-primary">description</span>
                  <div>
                    <h2 className="font-display text-xl font-bold text-slate-900 dark:text-white transition-colors">Executive Summary</h2>
                    {language !== "en" && (
