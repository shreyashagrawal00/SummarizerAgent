        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 overflow-hidden transition-colors">
          <div className="p-8">
            <div className="text-center mb-10">
              ...
              <h1 className="font-display text-3xl font-bold text-slate-900 dark:text-white transition-colors">Welcome Back</h1>
              <p className="text-slate-500 dark:text-slate-400 mt-2 transition-colors">Sign in to your Briefly account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="text-sm font-semibold text-slate-700 dark:text-slate-300 transition-colors" htmlFor="password">
                    Password
                  </label>
                  <a href="#" className="text-xs font-bold text-primary hover:underline transition-colors">Forgot?</a>
                </div>
                <div className="relative">
              ...
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember" className="ml-2 text-sm text-slate-600 dark:text-slate-400 transition-colors">
                  Keep me signed in
                </label>
              </div>
            ...
            <div className="mt-8">
              <div className="relative flex items-center justify-center">
                ...
                <span className="absolute bg-white dark:bg-slate-900 px-4 text-xs font-bold text-slate-400 dark:text-slate-500 tracking-widest uppercase transition-colors">Or</span>
              </div>
