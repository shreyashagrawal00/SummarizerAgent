  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-20">
      <div className="flex items-center justify-between mb-12">
        <h2 className="font-display text-3xl md:text-4xl font-bold dark:text-white transition-colors">Today's Selected Stories</h2>
        <a className="text-primary font-bold flex items-center gap-1 hover:underline transition-colors" href="/login">
          View Full Digest
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {stories.map((story, index) => (
          <div key={index} className="group cursor-pointer">
            <div className="aspect-video w-full overflow-hidden rounded-xl mb-4 bg-slate-100 dark:bg-slate-800 transition-colors">
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-display text-2xl font-bold leading-tight dark:text-white group-hover:text-primary transition-colors line-clamp-2">{story.title}</h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm line-clamp-3 transition-colors">{story.description}</p>
              <div className="flex items-center gap-4 pt-2 text-xs text-slate-500 dark:text-slate-500 font-medium transition-colors">
