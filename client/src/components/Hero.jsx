const Hero = () => {
  return (
    <section className="max-w-7xl mx-auto px-6 py-16 md:py-24 border-b border-slate-200 dark:border-slate-800">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="flex flex-col gap-8">
          ...
          <div className="space-y-4">
            <h1 className="font-display text-5xl md:text-7xl font-semibold leading-[1.1] tracking-tight text-slate-900 dark:text-slate-50">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button className="border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white text-base font-bold px-8 py-4 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-all flex items-center gap-3">
        ...
        <div className="relative lg:pl-10">
          <div className="aspect-[3/4] rounded-xl overflow-hidden shadow-2xl border-8 border-white dark:border-slate-800 bg-white dark:bg-slate-900 rotate-2 hover:rotate-0 transition-transform duration-500">
            <div className="p-8 space-y-6">
              ...
              <div className="space-y-4">
                <div className="w-full h-48 bg-slate-100 dark:bg-slate-800 rounded"></div>
                <h4 className="font-display text-xl font-bold leading-tight">1. Global Markets React to New Energy Infrastructure Bill</h4>
                <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed italic border-l-2 border-primary pl-4">
